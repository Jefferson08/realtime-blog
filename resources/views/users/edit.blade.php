                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('users.update', $user)}}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input id="name" type="text" value="{{$user->name}}" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $user->name }}" required autocomplete="name" autofocus>
...
@if(isset($user) && $user->photo)
      ...
      this.options.thumbnail.call(this, file, '{{ $user->photo->getUrl('preview') }}')
